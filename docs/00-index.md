...
### 5. 想看中枢台主线（Stage 36–38 display consumer milestone 已冻结）
...
- `92-filtered-snapshot-markdown-display-consumer-validation-gate.md` — Stage 36–38 display v1 stdin consumer design、实现、验收与 `v0.16.0` 冻结事实源（已收口）
...
- 当前稳定里程碑事实源：`92-filtered-snapshot-markdown-display-consumer-validation-gate.md` 与 `archive/release-notes/99-release-notes-v0.16.0-filtered-snapshot-display-consumer.md`
- 上一稳定里程碑事实源：`archive/91-codex-desktop-filtered-snapshot-markdown-display-integration-and-milestone-freeze.md`
...
| `archive/release-notes/` | 各阶段 release notes（最新为 `99-release-notes-v0.16.0-filtered-snapshot-display-consumer.md`） |
...
3. `archive/release-notes/99-release-notes-v0.16.0-filtered-snapshot-display-consumer.md`
