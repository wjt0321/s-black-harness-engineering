...
### 5. 想看中枢台主线（Stage 36 display consumer validation design gate 已冻结）
...
- `92-filtered-snapshot-markdown-display-consumer-validation-gate.md` — Stage 36 display v1 stdin consumer contract 与 Stage 37/38 边界（已收口）
...
- 当前设计事实源：`92-filtered-snapshot-markdown-display-consumer-validation-gate.md`
- 当前稳定里程碑事实源：`archive/91-codex-desktop-filtered-snapshot-markdown-display-integration-and-milestone-freeze.md`
- 上一稳定里程碑事实源：`archive/90-codex-desktop-filtered-snapshot-host-integration-and-milestone-freeze.md`
...
| `archive/release-notes/` | 各阶段 release notes（最新为 `97-release-notes-stage36-filtered-snapshot-markdown-display-consumer-validation-gate.md`） |
...
2. `92-filtered-snapshot-markdown-display-consumer-validation-gate.md`
3. `archive/91-codex-desktop-filtered-snapshot-markdown-display-integration-and-milestone-freeze.md`
4. 最新 handoff：`tasks/handoff-2026-07-16.md`
5. `89-codex-desktop-filtered-snapshot-consumer-implementation.md`
