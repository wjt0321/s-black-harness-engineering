...
### 5. 想看中枢台主线（Stage 39 display host integration design gate 已冻结）
...
- `93-codex-desktop-filtered-snapshot-display-host-integration-and-milestone-freeze.md` — Stage 39 display → consumer host contract 与 Stage 40/41 边界（已收口）
...
- 当前设计事实源：`93-codex-desktop-filtered-snapshot-display-host-integration-and-milestone-freeze.md`
- 当前稳定里程碑事实源：`archive/92-filtered-snapshot-markdown-display-consumer-validation-gate.md` 与 `archive/release-notes/99-release-notes-v0.16.0-filtered-snapshot-display-consumer.md`
...
| `archive/release-notes/` | 各阶段 release notes（最新为 `100-release-notes-stage39-filtered-snapshot-display-host-integration-gate.md`） |
