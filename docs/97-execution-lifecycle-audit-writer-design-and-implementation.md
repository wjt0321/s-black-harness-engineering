<!-- parents: archive/96-fixed-git-status-executor-design-gate.md, archive/56-orchestration-controlled-write-boundary.md -->
<!-- relates: archive/60-orchestration-run-lifecycle-events-design.md, archive/95-single-user-real-execution-readiness-gate-and-milestone.md -->
