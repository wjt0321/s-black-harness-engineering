...
冻结事实源为 `docs/archive/92-filtered-snapshot-markdown-display-consumer-validation-gate.md` 与 `docs/archive/release-notes/99-release-notes-v0.16.0-filtered-snapshot-display-consumer.md`。该 tag 未 push；自动启动上游、专有 UI、HTML/browser、file/URL、network/service、persistence/export、write 与真实 execution 继续 unavailable。
