...
<!-- relates: archive/82-read-only-representation-read-design-gate.md, archive/81-codex-desktop-read-only-adapter-implementation.md, 79-read-only-host-consumer-validation-boundary.md -->
