...
- `docs/archive/54-backend-preparation-before-ui.md` 定义了执行页 read model；本文档说明执行页操作入口（run dry-run/commit）在写入侧应如何沉淀产物。
- `docs/archive/56-orchestration-controlled-write-boundary.md` 定义了 dry-run/commit 统一语义；本文档将其应用到 run 命令。
